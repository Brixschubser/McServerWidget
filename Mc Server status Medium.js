...
function serverOnline(w) {
  ...
  title.font = Font.heavyRoundedSystemFont(20);

  let version = w.addText("V: " + res.version);
  version.font = Font.blackRoundedSystemFont(14);
  ...
  players.font = Font.blackRoundedSystemFont(14);
  if (res.players.online != 0) {
    let playerLs = w.addText(res.players.list.join(", "));
    playerLs.font = Font.lightRoundedSystemFont(14);
  }

  w.addSpacer();

  let date = w.addText(addDateTime());
  date.font = Font.mediumMonospacedSystemFont(10);
